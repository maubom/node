...
function RamalEditar(){
    ...
    useEffect(()=>{        
            api.get("ramais/"+id).then(res => {                
                setNome(res.data[0].nome);
                setSetor(res.data[0].setor);
                setRamal(res.data[0].ramal);
            }) 
    },[id]);
    ...
    <Navbar />
     ...
     <div className="container-fluid titulo">
        <div className="offset-lg-3 col-lg-6 " > 
            ...
            <h2 align="center">Editar Ramal</h2>  
            ...
            <form> 
                ...
                <div className="mb-3">    
                    ...
                    <input onChange={(e)=>setRamal(e.target.value)} type="text" defaultValue={ramal} className="form-control" id="floatingInput"  aria-describedby="nomeHelp" />                    
                </div>               
